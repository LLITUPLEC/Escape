        ...
        private async void OnLogoutClicked()
        {
            ...
            try
            {
                ...
                RunOnUiThread(() =>
                {
                    if (statusText != null)
                        statusText.text =
                            "Локально сброшен вход по e-mail (токены и сохранённый пароль); сейчас снова используется профиль устройства.\n" +
                            "В консоли Nakama e-mail по-прежнему привязан к старому user_id — это нормально (сброс только локальных данных).";
                    if (linkedEmailLineText != null)
