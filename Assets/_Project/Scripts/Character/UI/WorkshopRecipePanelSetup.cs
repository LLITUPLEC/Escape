...
namespace Project.Character.UI
{
    ...
    public static class WorkshopRecipePanelSetup
    {
        public readonly struct Refs
        {
            ...
            public Refs(Text recipeHeader, Text detailText, RectTransform recipeContent, Button create, Button claim, Button rush)
            {
        ...
        public static bool TryBindExisting(RectTransform workshopBackground, out Refs refs)
        {
            ...
            refs = new Refs(rh, dt, content, create, claim, rush);
            return true;
        }
        ...
        public static Refs Build(RectTransform workshopBackground)
        {
            ...
            var recipeHeader = CreateUiText("RecipeHeader", pr, "Выберите слот слева", 22, TextAnchor.UpperLeft,
            ...
            var detailText = CreateUiText("DetailText", pr, "", 18, TextAnchor.UpperLeft,
            ...
            return new Refs(recipeHeader, detailText, recipeContent, createButton, claimButton, rushButton);
        }
