 ...
 * 24 рецепта шахты recipe_drop_{green|blue|purple}_{Slot},
 * 8 золотых recipe_gold_{Slot},
 ...
 * игрок 12 ур., полный комплект, сет ×1.25 к сумме статов с вещей (крит без множителя — см. duel_match3).
 * Цель после мержа: HP = 1.6× hp_bonus, damage/armor/healing = 1.6× base_* монстра mine_11 той же «линейки»
